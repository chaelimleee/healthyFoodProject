...
public class BoardController { 
	...
	public String writeProc(@RequestParam Map<String, Object> map, 
		...
		Optional<BoardVO> resultVO = boardService.insertBoard(boardVO); //0424 Optional<>추가 &boardVO->resultVO변경
		
		log.info("----- 게시글 저장 BoardVO : {}", resultVO);
		
		if (resultVO.isEmpty() == false) { //0424 song resultVO.isEmpty() == false 로 변경
			msg = "게시글 저장에 성공하였습니다.";
		}
