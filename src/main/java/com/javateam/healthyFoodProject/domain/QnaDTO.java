...
//	private String qnaOriginalFile;// 첨부 파일(원래 파일명)
	...
	private int qnaReRefRef;//게시글 답글의 원 게시글(관련글) 번호
	private int qnaReLevLev;//게시글 답글 레벨
	private int qnaReSeqSeq;//게시글 답글 순서
