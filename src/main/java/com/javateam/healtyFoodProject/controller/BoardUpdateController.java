package com.javateam.healtyFoodProject.controller;
...
import com.javateam.healtyFoodProject.domain.BoardVO;
import com.javateam.healtyFoodProject.domain.UploadFile;
import com.javateam.healtyFoodProject.service.BoardService;
import com.javateam.healtyFoodProject.service.FileUploadService;
import com.javateam.healtyFoodProject.service.ImageService;
import com.javateam.healtyFoodProject.service.ImageStoreService;
import com.javateam.healtyFoodProject.util.FileUploadUtil;
	...
	public String updateProc(// @ModelAttribute("boardUpdateDTO") BoardDTO boardUpdateDTO,
		...
		if (defaultBoardVO.getBoardPass().equals(updateBoardVO.getBoardPass().trim())) {
			...
			if (defaultBoardVO.getBoardContent().trim().equals(updateBoardVO.getBoardContent().trim()) == false) {
				...
				//
				// ex) 글내용중 이미지가 들어간 내용 ex) <img src="/healtyFoodProject/board/image/18" .....
				...
				if (updateImgList.size() == 0) {
					...
					if (deleteExpectedImgList.size() > 0) {
						...
						for (int imageId : deleteExpectedImgList) {
							...
							// D:/lsh/works/spring_member/healtyFoodProject/upload/image/2024/03/12/a92e1a28f7e746b39afe7e83eb97a5d2.jpg
