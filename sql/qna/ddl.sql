...
CREATE TABLE qna_tbl (
  ...
  --  qna_pass varchar2(20) not null,-- song 0419 삭제
	...
	qna_re_ref NUMBER NOT NULL,--0423 song not null뺄까 고민 중
	qna_re_lev NUMBER NOT NULL,--0423 song not null뺄까 고민 중
	qna_re_seq NUMBER NOT NULL,--0423 song not null뺄까 고민 중
